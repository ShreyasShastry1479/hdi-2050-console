    ...
    for iso3 in sorted(UNDP_HDI_COUNTRIES_193):
        ...
        for religion in sorted(set(base) | set(projected)):
            ...
            rows.append({
                ...
                "Group": religion,
                "Profile": "religion",
                "Baseline_Evidence_Status": "compiled_religion_baseline_source_review_required",
                "Projection_Evidence_Status": "demographic_scenario_not_official_forecast",
                "Uncertainty_Evidence_Status": "scenario_sensitivity_not_calibrated_probability",
